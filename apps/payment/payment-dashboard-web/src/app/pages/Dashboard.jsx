                    ...
                    <div className="mt-3 text-gray-500 space-y-6">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-3">
                                <div className="flex items-center justify-center w-10 h-10 p-2 text-blue-600 bg-blue-100 rounded-lg">
                                    SP
                                </div>
                                <div>
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-3">
                                <svg
                                    className="justify-center w-10 h-10 p-2 text-orange-400 bg-orange-100 rounded-lg"
                                    fill="none"
                                    stroke="currentColor"
                                    viewBox="0 0 24 24"
                                    xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-3">
                                <div className="flex items-center justify-center w-10 h-10 p-2 text-red-500 bg-red-100 rounded-lg">
                                    AD
                                </div>
                                <div>
                                    <h4 className="text-sm font-medium text-gray-700">
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-3">
                                <svg
                                    className="justify-center w-10 h-10 p-2 text-purple-400 bg-purple-200 rounded-lg"
                                    fill="none"
                                    stroke="currentColor"
                                    viewBox="0 0 24 24"
                                    xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-3">
                                <div className="flex items-center justify-center w-10 h-10 p-2 text-blue-500 bg-blue-100 rounded-lg">
                                    DA
                                </div>
                                <div>
                                    <h4 className="text-sm font-medium text-gray-700">
                    ...
                    <div className="mt-3 text-gray-500 space-y-5">
                        ...
                        <div className="flex items-center justify-center">
                            <button className="flex items-center text-sm font-medium text-gray-700 space-x-2 focus:outline-none hover:outline-none group">
                                <span className="transition-all duration-300 ease-out transform group-hover:-translate-x-1">
                                    View All
                                </span>
                                <svg
                                    className="w-6 h-6 pr-2 text-gray-300 transition-all duration-300 ease-out transform group-hover:translate-x-1"
                                    fill="currentColor"
                                    viewBox="0 0 20 20"
                                    xmlns="http://www.w3.org/2000/svg"
                                >
                        ...
                        <table className="w-full">
                            <thead>
                                <tr className="text-gray-600">
                                    <th className="py-2 pl-5 text-sm font-normal text-left bg-blue-50">
                                        ID
                                    </th>
                                    ...
                                    <th className="py-2 pl-5 text-sm font-normal text-left bg-blue-50 rounded-r-md">
                                        Status
                                    </th>
                                </tr>
                            </thead>
