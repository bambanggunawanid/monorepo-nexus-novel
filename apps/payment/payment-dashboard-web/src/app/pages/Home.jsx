    ...
    return (
        <div>
                ...
                <div className="w-full xl:w-1/2 grid grid-cols-1 md:grid-cols-2 gap-6 text-indigo-900">
                    <div className="transition-all duration-300 border border-indigo-200 rounded-3xl p-4 lg:p-8 text-center flex flex-col space-y-8 hover:border-gray-200 hover:border-opacity-50 hover:shadow-2xl">
                        <div className="flex items-center justify-center">
                            <img src="assets/images/global-payment-icon-1.png" alt="" />
                        </div>
                    ...
                    <div className="transition-all duration-300 border border-indigo-200 rounded-3xl p-4 lg:p-8 text-center flex flex-col space-y-8 hover:border-gray-200 hover:border-opacity-50 hover:shadow-2xl">
                        <div className="flex items-center justify-center">
                            <img src="assets/images/global-payment-icon-2.png" alt="" />
                        </div>
                        <h3 className="text-xl lg:text-2xl font-bold text-indigo-900">
                            Business-Ready
                        </h3>
                    ...
                    <div className="transition-all duration-300 border border-indigo-200 rounded-3xl p-4 lg:p-8 text-center flex flex-col space-y-8 hover:border-gray-200 hover:border-opacity-50 hover:shadow-2xl">
                        <div className="flex items-center justify-center">
                            <img src="assets/images/global-payment-icon-3.png" alt="" />
                        </div>
                        <h3 className="text-xl lg:text-2xl font-bold text-indigo-900">
                            100% Transparent
                        </h3>
                    ...
                    <div className="transition-all duration-300 border border-indigo-200 rounded-3xl p-4 lg:p-8 text-center flex flex-col space-y-8 hover:border-gray-200 hover:border-opacity-50 hover:shadow-2xl">
                        <div className="flex items-center justify-center">
                            <img src="assets/images/global-payment-icon-4.png" alt="" />
                        </div>
                        <h3 className="text-xl lg:text-2xl font-bold text-indigo-900">
            ...
            <div
                ...
                style={{ backgroundImage: "url('assets/images/our-solutions-bg.png')" }}
            >
            ...
            <Container className="-mt-[150px] wow fadeInUp">
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
                    <div className="w-2/3 mx-auto md:w-full bg-white transition-all duration-300 border border-gray-200 border-opacity-50 rounded-3xl p-4 lg:p-8 text-center flex flex-col space-y-8 shadow-xl">
                        <div className="flex items-center justify-center">
                            <img src="assets/images/our-solutions-icon-1.png" alt="" />
                        </div>
                    ...
                    <div className="w-2/3 mx-auto md:w-full bg-white transition-all duration-300 border border-gray-200 border-opacity-50 rounded-3xl p-4 lg:p-8 text-center flex flex-col space-y-8 shadow-xl">
                        <div className="flex items-center justify-center">
                            <img src="assets/images/our-solutions-icon-2.png" alt="" />
                        </div>
                        <h3 className="text-xl lg:text-2xl font-bold text-indigo-900">
                            Collections
                        </h3>
                    ...
                    <div className="w-2/3 mx-auto md:w-full bg-white transition-all duration-300 border border-gray-200 border-opacity-50 rounded-3xl p-4 lg:p-8 text-center flex flex-col space-y-8 shadow-xl">
                        <div className="flex items-center justify-center">
                            <img src="assets/images/our-solutions-icon-3.png" alt="" />
                        </div>
                        <h3 className="text-xl lg:text-2xl font-bold text-indigo-900">
                            Conversions
                        </h3>
                    ...
                    <div className="w-2/3 mx-auto md:w-full bg-white transition-all duration-300 border border-gray-200 border-opacity-50 rounded-3xl p-4 lg:p-8 text-center flex flex-col space-y-8 shadow-xl">
                        <div className="flex items-center justify-center">
                            <img src="assets/images/our-solutions-icon-4.png" alt="" />
                        </div>
                        <h3 className="text-xl lg:text-2xl font-bold text-indigo-900">
                            Global Account
                        </h3>
                    ...
                    <div className="w-full lg:w-1/2 space-y-8">
                        ...
                        <div className="flex items-center space-x-3">
                            <button className="transition-all duration-300 hover:shadow-xl">
                                <img src="assets/images/GooglePlay-btn.png" alt="" />
                            </button>
