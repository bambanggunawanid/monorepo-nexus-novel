        ...
        <div>
            ...
            <div className="wow fadeInUp text-center text-indigo-900 space-y-8 mt-28 mb-16">
                ...
                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold">
                    The World At Your <br className="hidden lg:block" />{' '}
                    Fingertips
                </h1>
                ...
                <div className="w-full xl:w-1/2 grid grid-cols-1 md:grid-cols-2 gap-6 text-indigo-900">
                    <div className="transition-all duration-300 border border-indigo-200 rounded-3xl p-4 lg:p-8 text-center flex flex-col space-y-8 hover:border-gray-200 hover:border-opacity-50 hover:shadow-2xl">
                        <div className="flex items-center justify-center">
                            <img
                                src="assets/images/global-payment-icon-1.png"
                                alt=""
                            />
                        </div>
                    ...
                    <div className="transition-all duration-300 border border-indigo-200 rounded-3xl p-4 lg:p-8 text-center flex flex-col space-y-8 hover:border-gray-200 hover:border-opacity-50 hover:shadow-2xl">
                        <div className="flex items-center justify-center">
                            <img
                                src="assets/images/global-payment-icon-2.png"
                                alt=""
                            />
                        </div>
                        <h3 className="text-xl lg:text-2xl font-bold text-indigo-900">
                    ...
                    <div className="transition-all duration-300 border border-indigo-200 rounded-3xl p-4 lg:p-8 text-center flex flex-col space-y-8 hover:border-gray-200 hover:border-opacity-50 hover:shadow-2xl">
                        <div className="flex items-center justify-center">
                            <img
                                src="assets/images/global-payment-icon-3.png"
                                alt=""
                            />
                        </div>
                        <h3 className="text-xl lg:text-2xl font-bold text-indigo-900">
                    ...
                    <div className="transition-all duration-300 border border-indigo-200 rounded-3xl p-4 lg:p-8 text-center flex flex-col space-y-8 hover:border-gray-200 hover:border-opacity-50 hover:shadow-2xl">
                        <div className="flex items-center justify-center">
                            <img
                                src="assets/images/global-payment-icon-4.png"
                                alt=""
                            />
                        </div>
                        <h3 className="text-xl lg:text-2xl font-bold text-indigo-900">
            ...
            <div
                ...
                style={{
                    backgroundImage:
                        "url('assets/images/our-solutions-bg.png')",
                }}
            >
                ...
                <h1 className="wow fadeInUp text-3xl md:text-4xl xl:text-6xl font-bold">
                    All Your Payments In <br className="hidden lg:block" /> One
                    Place
                </h1>
                <p className="wow fadeInUp text-white font-medium text-opacity-80 text-sm md:text-base">
                    ...
                    international money <br /> transfers.Expand your business
                    worldwide
                </p>
            </div>
            ...
            <Container className="-mt-[150px] wow fadeInUp">
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
                    <div className="w-2/3 mx-auto md:w-full bg-white transition-all duration-300 border border-gray-200 border-opacity-50 rounded-3xl p-4 lg:p-8 text-center flex flex-col space-y-8 shadow-xl">
                        <div className="flex items-center justify-center">
                            <img
                                src="assets/images/our-solutions-icon-1.png"
                                alt=""
                            />
                        </div>
                        <h3 className="text-xl lg:text-2xl font-bold text-indigo-900">
                    ...
                    <div className="w-2/3 mx-auto md:w-full bg-white transition-all duration-300 border border-gray-200 border-opacity-50 rounded-3xl p-4 lg:p-8 text-center flex flex-col space-y-8 shadow-xl">
                        <div className="flex items-center justify-center">
                            <img
                                src="assets/images/our-solutions-icon-2.png"
                                alt=""
                            />
                        </div>
                        <h3 className="text-xl lg:text-2xl font-bold text-indigo-900">
                    ...
                    <div className="w-2/3 mx-auto md:w-full bg-white transition-all duration-300 border border-gray-200 border-opacity-50 rounded-3xl p-4 lg:p-8 text-center flex flex-col space-y-8 shadow-xl">
                        <div className="flex items-center justify-center">
                            <img
                                src="assets/images/our-solutions-icon-3.png"
                                alt=""
                            />
                        </div>
                        <h3 className="text-xl lg:text-2xl font-bold text-indigo-900">
                    ...
                    <div className="w-2/3 mx-auto md:w-full bg-white transition-all duration-300 border border-gray-200 border-opacity-50 rounded-3xl p-4 lg:p-8 text-center flex flex-col space-y-8 shadow-xl">
                        <div className="flex items-center justify-center">
                            <img
                                src="assets/images/our-solutions-icon-4.png"
                                alt=""
                            />
                        </div>
                        <h3 className="text-xl lg:text-2xl font-bold text-indigo-900">
                ...
                <div className="flex items-center flex-col-reverse  lg:flex-row space-x-16 mt-24">
                    <img
                        src="assets/images/app-download-img.png"
                    ...
                    <div className="w-full lg:w-1/2 space-y-8">
                        <div className="text-indigo-900 space-y-8 mt-28">
                            ...
                            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold">
                                Fast, Secure Money{' '}
                                <br className="hidden lg:block" /> Transfers
                            </h1>

                            <p className="text-sm sm:text-base">
                                Access your account via your mobile phone. View
                                balance, transfer <br /> funds, view
                                transactions wherever you are.
                            </p>
                        </div>
                        ...
                        <div className="flex items-center space-x-3">
                            <button className="transition-all duration-300 hover:shadow-xl">
                                <img
                                    src="assets/images/GooglePlay-btn.png"
                                    alt=""
                                />
                            </button>
