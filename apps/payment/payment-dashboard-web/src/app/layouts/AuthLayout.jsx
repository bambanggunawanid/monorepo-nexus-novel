                    ...
                    <div className="space-y-8 p-9">
                        ...
                        <div className="space-y-4">
                            ...
                            <p className="font-medium">
                                Discover how to manage Two-Factor Authentication
                                in{' '}
                                <br className="hidden lg:inline-block xl:hidden" />{' '}
                                Joomla. The two-factor{' '}
                                <br className="hidden xl:inline-block" />{' '}
                                authentication in Joomla is a very{' '}
                                <br className="hidden lg:inline-block xl:hidden" />{' '}
                                popular security practice.
                            </p>
                        </div>
                            ...
                            <div className="flex items-center -space-x-3">
                                {[1, 2, 3, 4].map((item) => (
                                    <img
                                        ...
                                        src={`assets/images/auth-${item}.jpeg`}
                                        alt=""
                                    />
                                ))}
                            </div>
