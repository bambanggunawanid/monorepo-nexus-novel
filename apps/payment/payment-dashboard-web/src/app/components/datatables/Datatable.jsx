            ...
            const button = (
                <Menu.Item>
                    {editButton.type === 'link' ? (
                        ...
                        <button
                            onClick={() => {
                                editButton.click(item);
                            }}
                            className="w-full focus:outline-none flex items-center px-2 py-1 font-light text-blue-500 bg-green-100 space-x-2"
                        >
                            <svg
                                className="w-6 h-6 p-1"
                                fill="none"
            ...
            const button = (
                <Menu.Item>
                    {viewButton.type === 'link' ? (
                        ...
                        <button
                            onClick={() => {
                                viewButton.click(item);
                            }}
                            className="w-full flex focus:outline-none items-center px-2 py-1 font-light text-blue-500 bg-green-100 space-x-2"
                        >
                            <svg
                                className="w-6 h-6 p-1"
                                fill="none"
                                            ...
                                            <div className="flex items-center justify-center">
                                                <Menu className="relative w-6 h-6">
                                                    <div>
                                                        ...
                                                        <Menu.Items
                                                            className={`absolute focus:outline-none shadow-sm right-0 z-10 p-2 bg-white border rounded-md w-36 space-y-2 cursor-pointer ${css(
                                                                styles.fadeInDown
                                                            )}`}
                                                        >
                                                            {showViewButton(
